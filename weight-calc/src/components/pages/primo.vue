  ...
  q-layout
    ...
    .layout-view
      .layout-padding
        .row
          .auto
            h5.text-center Табличка для расчета массы круглого блина для гантели (можно и штанги)
            p.text-center Подбирать массу блина с помощью значений "Толщина листа", "Внешний диаметр", "Внутренний диаметр"
        .row
          .auto
